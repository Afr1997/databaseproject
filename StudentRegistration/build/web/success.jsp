...
<body>
	<div id="wrapper">
		...
		<section class="left-col">
                    ...
                    <p style="padding-top: 40px;color:#663300;"><i><b><font size="5" face="Andalus"> congratulations you have been registered further details will be provided through e-mail</font> </i></b></p>
</p> 
<center><a href="index.jsp"><button><---- Back to home</button></a></center>
                    </div>
			</section>
		</section>

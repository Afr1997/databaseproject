...
<body>
	...
	<div id="wrapper">
		...
		<section class="left-col">
			<h1>Registration</h1>
			<p>The Institute is currently running the B.Tech programme(CS,Civil,EEE,ME) ADMISSIONS are open for the acadmic year 2020-2021.you can Register Here.</p>
			
			<section id="registration">
			<h1>Registration Form</h1>
                        
                        <!-- here is the form to submit, upon submit data is sent to submit.jsp-->

...
<body>
	<div id="wrapper">
        ...
        <tr>
            <td><img src="images/11.png" width="200" height="130" alt="11"/>
            </td>
            <td><img src="images/77.png" width="200" height="130" alt="22"/>
            </td>
        </tr>
        <tr>
            <td><img src="images/33.png" width="200" height="130" alt="33"/>
            </td>
            <td><img src="images/44.png" width="200" height="130" alt="44"/>
            </td>
        </tr>
        <tr>
            <td><img src="images/55.png" width="200" height="130" alt="55"/>
            </td>
            <td><img src="images/66.png" width="200" height="130" alt="66"/>
            </td>
        </tr>
		...
		<aside class="sidebar">
			<div class="mypic">
				<img src="images/007.jpg" title="Gagan kumar indoriya" alt="Gagan's image">
			</div>
